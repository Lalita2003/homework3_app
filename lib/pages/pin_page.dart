  ...
  Widget buildItem({
    ...
    return InkWell(
      child: Container(
        ...
        child: Column(
          children: [
            SizedBox(height: 10.0), // Add some vertical space between "PIN LOGIN" and the icon
...
Widget buildNumericButtonsGrid() {
  ...
  rows.add(Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        buildActionIconButton(Icons.more),
      ],
    ),
  ));
  ...
  return Container(
    ...
    height: 40.0,
    decoration: BoxDecoration(
      border: icon == Icons.close || icon == Icons.more
          ? null
          : Border.all(color: Colors.black), // Remove border for Icons.close and Icons.more
      borderRadius: BorderRadius.circular(8.0),
    ),
    child: ElevatedButton(
      onPressed: () {
        // Handle button click for Icons.close or Icons.more
        if (icon == Icons.close) {
          // Clear the entered PIN
          pinController.text = '';
        } else if (icon == Icons.more) {
